...
from utility.compute import compute_ranking_metrics, compute_comprehensive_ranking_metrics, compute_retraining_based_metrics
from utility.evaluation_metrics import *
import random
...
def main(config_args=None):
    ...
    save_name = "Weights/MF_SCIF/mf_dataset_{}_attack_{}_lr_{}_khop_{}_emb_{}.pth".format(args.dataset, args.attack, args.if_lr, args.k_hop, args.embed_size)

...
class influence_unlearn(nn.Module):
    ...
    def compute_hessian_with_test(self, model=None, data_generator=None, original_model=None, args=None, baseline_valid_recall_20=None):
        ...
        label_path = os.path.join(args.data_path, args.dataset, args.attack, 'avg_labels.npy') if args is not None else os.path.join('Data','Process','Amazon_Book','0.01','avg_labels.npy')

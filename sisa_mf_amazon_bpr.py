...
from utility.compute import compute_ranking_metrics, compute_comprehensive_ranking_metrics, compute_ranking_metrics_sisa, compute_comprehensive_ranking_metrics_sisa, compute_retraining_based_metrics_sisa
...
def main(config_args):
    ...
    for i in range(args.part_num):
        ...
        #  partition positive interaction  
        ...
        for epoch in range(args.epoch):
            ...
            for batch_idx in range(n_batches):
                ...
                # BPR loss  - embedding lookup  float  
            ...
            # test_metrics = compute_ranking_metrics_sisa(model, data_generator.test, data_generator, k_list, local_id=i)

            # NDCG@20 early stopping  
            valid_ndcg = valid_metrics['ndcg_at_20']
            # test_ndcg = test_metrics['ndcg_at_20']
    ...
    for epoch in range(args.epoch):
        t1 = time()
        loss, bpr_loss, reg_loss, attention_loss = 0., 0., 0., 0.
        model.train()

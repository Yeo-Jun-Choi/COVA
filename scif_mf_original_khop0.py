...
class influence_unlearn(nn.Module):
    ...
    def compute_hessian_with_test(self, model=None, data_generator=None, args=None):
        ...
        ## scif
        label_path = os.path.join(args.data_path, args.dataset, args.attack, 'avg_labels.npy') if args is not None else os.path.join('Data','Process','BookCrossing','0.02','avg_labels.npy')
...
def main(config_args=None):
    ...
    save_name = './Weights/MF/MF_lr-0.001-embed_size-48-batch_size-2048-data_type-full-dataset-BookCrossing-attack-0.02-seed-1024-init_std-0.001-m.pth'
    ...
    unlearn.compute_hessian_with_test(model=model,data_generator=data_generator, args=args)
    model.load_state_dict(torch.load(save_name))
...
if __name__=='__main__':
    ...
    config_args['dataset'] = 'BookCrossing'
